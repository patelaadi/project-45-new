...
rattata1.addAnimation("rattata1",rattata_image);
rattata1.scale = 0.25;
rattata1.rotationToDirection = true;
rattata1.velcoityX = 1;

rattata2 = createSprite(200,610,30,30);
rattata2.addAnimation("rattata2",rattata_image);
rattata2.scale = 0.25;
...
//rattata moving
if(rattata1.x>590){
  rattata1.changeAnimation("rat1",rattata_image);
...
if (rattata1.x<100) {
  rattata1.changeAnmation("rat1_flip",rattata_flip);
  rattata1.velocityX = 1;
  rattata1.velocityY = rattata1.velocityY +0.8;
...
if(rattata2.x>900){
 ...
 rattata2.changeAnimation("rat2",rattata_image);
}

if (rattata2.x<150) {
  rattata2.velocityX = 1;
  rattata2.velocityY = rattata2.velocityY +0.8;
  rattata2.changeAnimation("rat2_flip",rattata_flip);
} 
...
if(keyDown("RIGHT_ARROW")){
  ash.changeAnimation("right_walk",ash_walk_right);
  ash.scale = 0.13;
  ash.velocityX = 2;
